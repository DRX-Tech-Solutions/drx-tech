...
export const projects: Project[] = [
  {
    ...
    name: "DRX Cleaning",
    description:
      "Website profissional de venda de serviços para empresa de limpeza. Múltiplas páginas, SEO otimizado e foco em captura de orçamentos online.",
    category: "Website Profissional",
    tags: ["Next.js", "Tailwind", "SEO", "Multi-página"],
  ...
  },
  {
    ...
    name: "Protagonize",
    description:
      "Plataforma completa para venda de mentoria e cursos online. Landing page de alta conversão integrada com área de membros para alunos.",
    category: "Plataforma de Mentoria",
    tags: ["React", "Framer Motion", "CRO", "Plataforma de Curso"],
  ...
  },
  {
    ...
    name: "DX Marcenaria",
    description:
      "Site de venda de serviços com portfólio premium para marcenaria especializada em móveis planejados. Galeria de projetos e captação de orçamentos.",
    category: "Portfólio & Serviços",
    tags: ["Next.js", "Gallery", "WhatsApp", "Portfólio"],
